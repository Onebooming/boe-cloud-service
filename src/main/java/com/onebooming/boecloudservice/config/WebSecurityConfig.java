package com.onebooming.boecloudservice.config;


import com.onebooming.boecloudservice.service.UserService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/blogimg/**","/index.html","/static/**","/mappers/**");
    }
